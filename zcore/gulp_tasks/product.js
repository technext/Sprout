...
gulp.task('product', ['product:sass', 'product:pug', 'product:assets']);
...
gulp.task('product:sass', function () {
...
gulp.task('product:assets', ['product:images', 'product:videos', 'product:fonts', 'product:js', 'product:php', 'product:lib', 'product:bower']);
...
gulp.task('product:php', function () {
 	return gulp.src(['./zcore/php/**/*.php', './php/**/*.php'])
        .pipe(gulp.dest('product/HTML/php/'));
});


/* Merge & push bower main files */
gulp.task('product:bower', function() {
